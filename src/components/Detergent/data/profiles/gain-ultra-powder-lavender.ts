...
const GainUltraPowderLavender: DetergentProfile = new DetergentProfile(
  'Ultra Powder Lavender',
  'Gain',
...
GainUltraPowderLavender.countryOfOrigin = 'USA';
GainUltraPowderLavender.countriesAvailable = ['USA'];

export default GainUltraPowderLavender;
