...
const TideUltraOxiLiquid: DetergentProfile = new DetergentProfile(
    "Ultra Oxi", "Tide", DetergentType.Liquid, ingredients, new Date("2026-02-08"));
TideUltraOxiLiquid.countryOfOrigin = "USA";
TideUltraOxiLiquid.countriesAvailable = ["USA"];

export default TideUltraOxiLiquid;
