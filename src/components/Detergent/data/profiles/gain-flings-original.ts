...
const GainFlingsOriginal: DetergentProfile = new DetergentProfile(
  'Flings! Original',
  'Gain',
  DetergentType.Pod,
  DataSource.Package,
...
GainFlingsOriginal.countryOfOrigin = 'USA';
GainFlingsOriginal.countriesAvailable = ['USA'];

export default GainFlingsOriginal;
