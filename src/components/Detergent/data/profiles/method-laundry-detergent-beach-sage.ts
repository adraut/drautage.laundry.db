...
const ingredients: Ingredient[] = [
  ...
  Ingredient.PolymericBlue,
  Ingredient.PolymericYellow,
];

const MethodLaundryDetergentBeachSage: DetergentProfile = new DetergentProfile(
  'Beach Sage',
  'Method',
...
export default MethodLaundryDetergentBeachSage;
