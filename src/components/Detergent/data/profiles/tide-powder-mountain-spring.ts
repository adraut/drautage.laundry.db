...
const TidePowderMountainSpring: DetergentProfile = new DetergentProfile(
  'Powder Mountain Spring',
  'Tide',
...
TidePowderMountainSpring.countryOfOrigin = 'USA';
TidePowderMountainSpring.countriesAvailable = ['USA'];

export default TidePowderMountainSpring;
